...
#multipart alternative: text and html.Upto clint to determine which get shown.
def make_mpa_msg():
...
# take basic email sending criteria , transmit message and return to caller
    s = SMTP('localhost')
    errs = s.sendmail(fr,to,msg)
    s.quit()

if __name__=='__main__':
    print 'Sending multipart attachment message...'
    msg = make_mpa_msg()
    msg['From']=SENDER
    msg['To']=','.join(RECIPS)
